...
#Creating the labels.
    def create_labels(self):
        self.main_label = tk.Label(self, text = "BMI calculator", bg="#98FB98", fg="#000000", font=("Arial", 25), highlightbackground="black", highlightthickness=1)
        ...
        self.chart_photo=Image.open("C:/Users/iamar/OneDrive/Pictures/A LEVELS/NEA/BMI NEA.png")
